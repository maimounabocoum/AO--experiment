...
function [SEQ,MedElmtList,NUX,NUZ] = AOSeqInit_OJMLusmeasure(AixplorerIP, Volt , f0 , NbHemicycle , NbX , NbZ , X0 , X1 ,Prof, NTrig,DurationWaveform,ScanIndex);
...
for nbs = 1
        ...
        nuZ  = NBZ(ScanIndex)*nuZ0; % fréquence de modulation de phase (en Hz) 
        nuX  = NBX(ScanIndex)*nuX0;  % fréquence spatiale (en mm-1)
