...
%% Init program
function [SEQ,MedElmtList] = AOSeqInit_OFL(AixplorerIP, Volt , f0 , NbHemicycle , Foc, X0 , X1 , Prof ,NTrig)
...
NoOp         = 10500;         % µs minimum time between two US pulses, (5 by default ??)
