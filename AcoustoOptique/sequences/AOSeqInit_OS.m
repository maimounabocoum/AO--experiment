...
function [SEQ,Delay,ScanParam,ActiveLIST,AlphaM,dFx] = AOSeqInit_OS(AixplorerIP, Volt , f0 , NbHemicycle , AlphaM , Nbx , X0 , X1 ,Prof, NTrig , frep,Master)
...
ELUSEV{nbs} = elusev.elusev( ...
    ...
    'TrigIn',       0,...
    'TrigAll',      1, ...
    'TrigOutDelay', 0, ... %edit to adjust  acquire
    0);
            case 'off'
