...
function [] = AcoustoOptiqueThomas(sequence)
disp('Called');
return;
     ...
     % 'OC' : Ondes Chirpées
            ...
            TypeOfSequence  = 'BAS'; % 'OP','OS','JM','OC','OFJM', 'BAS'
            Bacules         = 'on';
            Master          = 'on';
            GageActive      = 'on' ; 
            Volt            = 15; %Volt
            seq_time        = 40e-6; % Sequence duration in s
    ...
    [SEQ,MedElmtList,nuX0,nuZ0,NUX,NUZ,ParamList] = AOSeqInit_OC(AixplorerIP, Volt , FreqSonde , NbHemicycle , NbX , NbZ , X0 , X1 , NTrig , DurationWaveform , Tau_cam );
        ...
        case 'BAS'
            Volt = min(Volt, 15);
            [SEQ,ActiveLIST,nuX0,nuZ0,NUX,NUZ] = AOSeqInit_Bas(AixplorerIP, Volt , FreqSonde , NbHemicycle , NbX , NbZ , X0 , X1 ,NTrig ,NU_low,Tau_cam , Phase , Frep , Bacules , Master, seq_time, sequence);
    end
