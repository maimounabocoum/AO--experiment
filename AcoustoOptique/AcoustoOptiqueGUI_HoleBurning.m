...
% new AIXPLORER : '192.168.1.10'
 ...
 addPathLegHAL;
       ...
       TypeOfSequence = 'OF';    %'OF'(focused waves) , 'OS' (plane structures waves), 
        ...
        Volt        = 20;        % 'OF' , 'OS', 'OP' , 'JM' Volt - ne pas depasser 50V
        ...
        X1          = 50 ;       % 'OF' , 'OS', 'OP' , 'JM' in mm
        PosOFscan   = 15:1:20; % 'OF'
        ...
        Frep            =  max(2,1000) ;   % 'OF' , 'OS', 'OP' , 'JM'in Hz
        USemissionDelay = 0;   % 'OP' emission delay in us (error x10 in new aixplorer)
