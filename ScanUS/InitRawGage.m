function [ret,handle,acqInfo,sysinfo] = InitRawGage(NTrig,Npoints,N_holdoff,SamplingRate,Range,TriggerSatus)
...
acqInfo.Depth           = ceil(Npoints/32)*32; % Must be a multiple of 32
...
acqInfo.TriggerHoldoff  = N_holdoff; % Number of points during which the card ignores trigs
...
switch TriggerSatus
    ...
    case 'on'
trig.Trigger            = 1;
trig.Slope              = CsMl_Translate('Positive', 'Slope'); % Aixplorer Trig has a neg slope
