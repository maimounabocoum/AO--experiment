...
% enregistrement
date='1501122';
path='G:\JB\Data\OndesPlanes\';
nomgogol = 'GelInclusionCroix';
...
%Pour un scan 2D
X0 = 0; %position de départ du scan en X, mm
...
N_points = 1520000; % 1080000;  %751000;%round(1520000/56*20);
SampleRate = 4e7;
Tps = 38; %14; %27; %temps par ligne d'acquisition en µs
N_trig = 2;%*2; %2000
DAQFileName = 'multi-record_1000moy_sr40MHz_200mV_38us_par_ligne';
