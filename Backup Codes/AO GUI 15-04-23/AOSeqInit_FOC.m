...
SEQfilename=['D:\AcoustoOptique\SEQdir\SEQ' ...
    ...
    '_X0_'     num2str(X0) ...
    '_Length_' num2str(ScanLength) ...
    '_Prof_'   num2str(Prof) ...
    '_NTrig_'  num2str(NTrig) '.mat'];


if exist(SEQfilename,'file');
    load(SEQfilename,'SEQ');
    display('Loading existing SEQ')
else
    %% Probe parameters
    ...
    CP.Pause      = max(200-ceil(1/CP.PRF),system.hardware.MinNoop); % pause duration in µs
