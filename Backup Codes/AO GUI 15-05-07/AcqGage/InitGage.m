...
acqInfo.SegmentCount    = AO.NTrig*Nlignes; % Number of memory segments (Nlines*Nmoy)
%acqInfo.Depth           = ceil((acqInfo.SampleRate*1e-3*AO.Prof/(common.constants.SoundSpeed))/32)*32; % Must be a multiple of 32
acqInfo.Depth           = ceil((acqInfo.SampleRate*1e-6*ceil(AO.Prof/(common.constants.SoundSpeed*1e-3)))/32)*32; % Must be a multiple of 32
