...
ImagingVoltage = 8;             % imaging voltage [V]
...
UF.TwFreq       = (2.5)/(UF.PulseInversion+1) ; % emission frequency [MHz]
UF.NbHcycle     = 200;               % # of half cycles
...
UF.PRF          = 1;            % pulse frequency repetition [Hz], between 2 different flats images (0 for greatest possible)
UF.FrameRateUF  = 2;
UF.FrameRate    = 0;
