...
%       [-40 40] °
%     - PRF (single) sets the pulse repetition frequency (usual definition of Doppler), related to Scale = lambda/4*PRF.
...
%      - NUMBERLINESPERBOX : number of transmit firings per pulse repetition interval
