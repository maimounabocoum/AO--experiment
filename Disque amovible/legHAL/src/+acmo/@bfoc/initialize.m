...
%
%   OBJ = OBJ.INITIALIZE() returns a generic ACMO.BFOC instance.
%
%   OBJ = OBJ.INITIALIZE(DEBUG) returns a generic ACMO.BFOC instance using
%   the DEBUG value (1 is enabling the debug mode).
%
%   OBJ = OBJ.INITIALIZE(NAME, DESC, DEBUG) returns an ACMO.BFOC instance
...
%   ACMO.BFOC instance with parameters PARSNAME set to PARSVALUE.
%
