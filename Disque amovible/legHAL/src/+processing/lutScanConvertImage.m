function Data = lutScanConvertImage( BFStruct, ImgInfo, Nx, Nz )
    ...
    parameters.NR = BFStruct.Lut(1).NPixLine;
    parameters.NTheta = BFStruct.Lut(1).NLines * BFStruct.Lut(1).NRecon;
    parameters.Nx = Nx ;
    parameters.Nz = Nz ;
