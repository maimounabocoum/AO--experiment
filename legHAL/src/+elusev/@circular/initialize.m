% ELUSEV.CIRCULAR.INITIALIZE (PROTECTED)
%   Build the remoteclass ELUSEV.CIRCULAR.
%
%   OBJ = OBJ.INITIALIZE() returns a generic ELUSEV.CIRCULAR instance.
%
%   OBJ = OBJ.INITIALIZE(DEBUG) returns a generic ELUSEV.CIRCULAR instance using the
%   DEBUG value (1 is enabling the debug mode).
%
%   OBJ = OBJ.INITIALIZE(NAME, DESC, DEBUG) returns an ELUSEV.CIRCULAR instance with
